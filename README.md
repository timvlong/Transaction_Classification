...
The file 'split_data.py' converts the labelled .csv file into a **pandas DataFrame** and drops any unnecessary / sensitive fields. A new field, 'Amount', is created to represent the net amount credited into the account. This field replaces the separate 'Debit Amount' and 'Credit Amount' fields. The dataframe is divided into training and testing data. 80% of our transactions are used to train the model and 20% for testing it.
